...
--COMANDOS PARA ALTERAR ALGUM DADO NA TABELA DDL
...
alter table livros add column editora VARCHAR(50) not null default 'N/A';
alter table livros drop column EDITORA;
alter table livros alter column EDITORA type VARCHAR(100);
alter table livros rename column EDITORA to EDITORA_LIVRO;

--COMANDOS PARA MODOFICAR ALGUM DADO NA TABELA DML
--UPDATE
--DELETE

update livros set titulo_livro = 'LIVRO X'
where ano_publicacao = 1998;
